...
:FixCortana
cls
ECHO für diese Option bitten wir dich in den Safe-Mode mit Netzwerktreibern zu 
...
Echo Wenn das nicht geht Logge dich aus. Drücke auf den Ausknopf
ECHO in der rechten Ecke. Halte dann Shift gedrückt und drücke
